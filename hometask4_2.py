...
quantity_berries = int(input('Введите кол-во кустов: '))
arr = list()

for i in range(quantity_berries):
    bush_number = int(input('Введите кол-во ягод на кусте: '))
    arr.append (bush_number)
